...
const camposAvancados = [
  "sci_report","cod_acessorias","opc_rec_patronal","honorarios","visitacao","tempo_demandado",
  "forma_comunica","demanda_folha","demanda_ad_13","demanda_13","motivo_termino","serv_prest","serv_tom","deson",
  "secconci","planilha_folha","planilha_convenio","sst","apura_vt",
...
const [filters, setFilters] = useState({
  ...
  const handleExportar = useCallback(() => {
    const headers = [
      { key: 'cod_folha', label: 'Cód. Folha' },
      { key: 'cod_geral', label: 'Cód. Geral' },
      { key: 'cod_acessorias', label: 'Cód. Acessórias' },
      { key: 'razao_social', label: 'Razão Social' },
      { key: 'forma_comunica', label: 'Forma Comunicação' },
      { key: 'grupo_economico', label: 'Grupo Econômico' },
      { key: 'cnpj', label: 'CNPJ' },
      { key: 'cnpj_original', label: 'CNPJ Original' },
      { key: 'status_do_cliente', label: 'Status Cliente' },
      { key: 'apelido', label: 'Apelido' },
      { key: 'inicio_contrato', label: 'Início Contrato' },
      { key: 'termino_contrato', label: 'Término Contrato' },
      { key: 'motivo_termino', label: 'Motivo Término' },
      { key: 'tributacao', label: 'Tributação' },
      { key: 'sistema', label: 'Sistema' },
      { key: 'resp_dp', label: 'Responsável DP' },
      { key: 'ramal', label: 'Ramal' },
      { key: 'voip', label: 'Voip' },
      { key: 'grupo', label: 'Grupo' },
      { key: 'data_pagto_salario', label: 'Data Pagto Salário' },
      { key: 'classificacao', label: 'Classificação' },
      { key: 'sci_report', label: 'SCI Report' },
      { key: 'visitacao', label: 'Visitação' },
      { key: 'matriz', label: 'Matriz' },
      { key: 'tempo_demandado', label: 'Tempo Demandado' },
      { key: 'demanda_folha', label: 'Demanda Folha' },
      { key: 'demanda_13', label: 'Demanda 13º' },
      { key: 'demanda_ad_13', label: 'Demanda Ad. 13º' },
      { key: 'enviadctf', label: 'Envia DCTF' },
      { key: 'classificacao2', label: 'Classificação 2' },
      { key: 'cod_folha_520', label: 'Cód. Folha 520' },
      { key: 'serv_prest', label: 'Serv. Prestados' },
      { key: 'serv_tom', label: 'Serv. Tomados' },
      { key: 'folha_tom', label: 'Folha Tomador' },
      { key: 'deson', label: 'Desoneração' },
      { key: 'secconci', label: 'SECONCI' },
      { key: 'planilha_folha', label: 'Planilha Folha' },
      { key: 'planilha_convenio', label: 'Planilha Convênio' },
      { key: 'sst', label: 'SST' },
      { key: 'data_entrega_folha', label: 'Entrega Folha' },
      { key: 'adiantamento', label: 'Adiantamento' },
      { key: 'dt_adiantamento_entrega', label: 'Adiant. Entrega' },
      { key: 'dt_adiantamento_pagamento', label: 'Adiant. Pagamento' },
      { key: 'perc_adiantamento', label: '% Adiantamento' },
      { key: 'dt_13_entrega', label: '13º Entrega' },
      { key: 'dt_13_adiantamento_entrega', label: '13º Adiant. Entrega' },
      { key: 'plr', label: 'PLR' },
      { key: 'plr_dt_entrega', label: 'PLR Entrega' },
      { key: 'plr_dt_pagto', label: 'PLR Pagamento' },
      { key: 'periodo_ponto', label: 'Período Ponto' },
      { key: 'tipo_ponto', label: 'Tipo Ponto' },
      { key: 'ponto_ini', label: 'Ponto Início' },
      { key: 'ponto_fim', label: 'Ponto Fim' },
      { key: 'ponto_entrega', label: 'Ponto Entrega' },
      { key: 'fecha_ponto', label: 'Fecha Ponto' },
      { key: 'envia_ponto', label: 'Envia Ponto' },
      { key: 'honorarios', label: 'Honorários' },
      { key: 'link_out_sist', label: 'Link Sistema' },
      { key: 'login_out_sist', label: 'Login Sistema' },
      { key: 'sen_out_sist', label: 'Senha Sistema' },
      { key: 'cad_pat', label: 'Cad. PAT' },
      { key: 'usu_pat', label: 'Usu. PAT' },
      { key: 'sen_pat', label: 'Senha PAT' },
      { key: 'tem_pat', label: 'Tem PAT' },
      { key: 'sd_login', label: 'SD Login' },
      { key: 'sd_senha', label: 'SD Senha' },
      { key: 'sd_email', label: 'SD Email' },
      { key: 'dt_envio_cct', label: 'Envio CCT' },
      { key: 'opc_rec_patronal', label: 'Opc. Rec. Patronal' },
      { key: 'dt_venc_conec_social', label: 'Venc. Conect. Social' },
      { key: 'venc_procuracao', label: 'Venc. Procuração' },
      { key: 'venc_fgts_digital', label: 'Venc. FGTS Digital' },
      { key: 'fgts_digital', label: 'FGTS Digital' },
      { key: 'tem_det', label: 'Tem DET' },
      { key: 'tem_fap', label: 'Tem FAP' },
      { key: 'apura_vt', label: 'Apura VT' },
      { key: 'med_ocupa_proc_venc', label: 'Med. Ocupa Proc. Venc.' },
      { key: 'prazo_admissao', label: 'Prazo Admissão' },
      { key: 'prazo_ferias', label: 'Prazo Férias' },
      { key: 'prazo_rescisao', label: 'Prazo Rescisão' },
    ];
    const rows = empresasFiltradas.map(e => ({
      cod_folha: e.cod_folha || '',
      cod_geral: e.cod_geral || '',
      cod_acessorias: e.cod_acessorias || '',
      razao_social: e.razao_social || '',
      forma_comunica: e.forma_comunica || '',
      grupo_economico: e.grupo_economico || '',
      cnpj: e.cnpj_formatado || e.cnpj || '',
      cnpj_original: e.cnpj_original || '',
      status_do_cliente: e.status_do_cliente || '',
      apelido: e.apelido || '',
      inicio_contrato: e.inicio_contrato || '',
      termino_contrato: e.termino_contrato || '',
      motivo_termino: e.motivo_termino || '',
      tributacao: e.tributacao || '',
      sistema: e.sistema || '',
      resp_dp: e.resp_dp || '',
      ...
      sci_report: e.sci_report || '',
      visitacao: e.visitacao || '',
      matriz: e.matriz || '',
      tempo_demandado: e.tempo_demandado || '',
      demanda_folha: e.demanda_folha || '',
      demanda_13: e.demanda_13 || '',
      demanda_ad_13: e.demanda_ad_13 || '',
      enviadctf: e.enviadctf || '',
      classificacao2: e.classificacao2 || '',
      cod_folha_520: e.cod_folha_520 || '',
      serv_prest: e.serv_prest || '',
      serv_tom: e.serv_tom || '',
      folha_tom: e.folha_tom || '',
      deson: e.deson || '',
      secconci: e.secconci || '',
      planilha_folha: e.planilha_folha || '',
      planilha_convenio: e.planilha_convenio || '',
      sst: e.sst || '',
      data_entrega_folha: e.data_entrega_folha || '',
      adiantamento: e.adiantamento || '',
      dt_adiantamento_entrega: e.dt_adiantamento_entrega || '',
      dt_adiantamento_pagamento: e.dt_adiantamento_pagamento || '',
      perc_adiantamento: e.perc_adiantamento || '',
      dt_13_entrega: e.dt_13_entrega || '',
      dt_13_adiantamento_entrega: e.dt_13_adiantamento_entrega || '',
      plr: e.plr || '',
      plr_dt_entrega: e.plr_dt_entrega || '',
      plr_dt_pagto: e.plr_dt_pagto || '',
      periodo_ponto: e.periodo_ponto || '',
      tipo_ponto: e.tipo_ponto || '',
      ponto_ini: e.ponto_ini || '',
      ponto_fim: e.ponto_fim || '',
      ponto_entrega: e.ponto_entrega || '',
      fecha_ponto: e.fecha_ponto || '',
      envia_ponto: e.envia_ponto || '',
      honorarios: e.honorarios || '',
      link_out_sist: e.link_out_sist || '',
      login_out_sist: e.login_out_sist || '',
      sen_out_sist: e.sen_out_sist || '',
      cad_pat: e.cad_pat || '',
      usu_pat: e.usu_pat || '',
      sen_pat: e.sen_pat || '',
      tem_pat: e.tem_pat || '',
      ...
      sd_senha: e.sd_senha || '',
      sd_email: e.sd_email || '',
      dt_envio_cct: e.dt_envio_cct || '',
      opc_rec_patronal: e.opc_rec_patronal || '',
      dt_venc_conec_social: e.dt_venc_conec_social || '',
      venc_procuracao: e.venc_procuracao || '',
      venc_fgts_digital: e.venc_fgts_digital || '',
      fgts_digital: e.fgts_digital || '',
      tem_det: e.tem_det || '',
      tem_fap: e.tem_fap || '',
      apura_vt: e.apura_vt || '',
      med_ocupa_proc_venc: e.med_ocupa_proc_venc || '',
      prazo_admissao: e.prazo_admissao || '',
      prazo_ferias: e.prazo_ferias || '',
      prazo_rescisao: e.prazo_rescisao || '',
    }));
    const d = new Date();
